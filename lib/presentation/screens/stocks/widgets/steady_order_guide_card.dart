    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Text(
            'T값 (회차)\n'
            '지금까지 투자한 금액을 1회 매수금으로 나눈 값입니다. '
            'T가 클수록 원금이 많이 소진된 것입니다.\n'
            '예: T=5 → 5회분 투입 완료\n\n'
            '오프셋 (별%)\n'
            'LOC 주문가를 평균매입가 대비 몇%로 설정할지 결정합니다. '
            'T가 커질수록 오프셋이 낮아져 더 싼 가격에서만 매수합니다.\n'
            '예: +10% → 평단보다 10% 비싸도 매수\n'
            '    -5% → 평단보다 5% 싸야만 매수\n\n'
            'LOC 주문\n'
            '종가 기준 조건부 주문입니다.\n'
            ...
            '• 매도 LOC: 종가 ≥ 설정가 → 체결\n\n'
            'LOC A / LOC B\n'
            '전반전에 2종류 매수 주문을 동시에 겁니다.\n'
            'V2.2: A=평단가, B=오프셋가\n'
            'V3.0: A=오프셋가, B=평단가\n\n'
            '전반전 / 후반전\n'
            '총 분할의 절반을 기준으로 구분합니다.\n'
            '• 전반전: 2종 주문 (넓은 범위 매수)\n'
            '• 후반전: 1종 주문 (보수적 매수)\n\n'
            '반복리 (V3.0)\n'
            '매도 수익의 일부(1/40)를 다음 매수금에 추가하여 '
            '복리 효과를 얻는 방식입니다. 손해 시에는 매수금을 유지합니다.',
