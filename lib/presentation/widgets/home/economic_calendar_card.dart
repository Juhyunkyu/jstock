...
const _eventDescriptions = <String, ({String desc, String higher, String lower})>{
  ...
  // ─── 인플레이션 (근원/헤드라인) ───
  '근원 인플레이션율 전월비': (
    desc: '식품·에너지를 제외한 소비자물가 상승률. 기초적 물가 추세를 파악하는 핵심 지표.',
    higher: '물가 상승 → 금리 인상 압력 → 주식시장 부정적',
    lower: '물가 안정 → 금리 인하 기대 → 주식시장 긍정적',
  ),
  '근원 인플레이션율 전년비': (
  ...
  '인플레이션율 전월비': (
    desc: '소비자물가의 월간 변동률. 단기 물가 추세와 연준 정책 방향에 영향.',
    higher: '물가 상승 → 금리 인상 압력 → 주식시장 부정적',
    lower: '물가 안정 → 금리 인하 기대 → 주식시장 긍정적',
  ),
  '인플레이션율 전년비': (
    desc: '소비자물가의 연간 변동률. 물가 추세의 큰 그림을 보여주는 지표.',
    higher: '물가 상승 → 금리 인상 압력 → 주식시장 부정적',
    lower: '물가 안정 → 금리 인하 기대 → 주식시장 긍정적',
  ),
  ...
  // ─── 미시간 소비자지수 (속보/확정) ───
  '미시간 소비자심리지수(속보)': (
    desc: '미시간대학 소비자 심리 조사 속보치. 확정치에 앞서 소비 전망을 선반영.',
    higher: '소비자 심리 개선 → 소비 증가 기대 → 경기 활력',
    lower: '소비자 심리 악화 → 소비 위축 우려 → 경기 둔화',
  ),
  '미시간 소비자심리지수(확정)': (
    desc: '미시간대학 소비자 심리 조사 확정치. 속보 이후 추가 응답을 반영한 최종값.',
    higher: '소비자 심리 개선 → 소비 증가 기대 → 경기 활력',
    lower: '소비자 심리 악화 → 소비 위축 우려 → 경기 둔화',
  ),
  '미시간 현재경기지수(속보)': (
    desc: '소비자가 체감하는 현재 경기 상황. 실제 소비 행동과 높은 상관관계.',
    higher: '현재 경기 체감 개선 → 소비 활발',
    lower: '현재 경기 체감 악화 → 소비 위축',
  ),
  '미시간 현재경기지수(확정)': (
    desc: '소비자가 체감하는 현재 경기 상황. 실제 소비 행동과 높은 상관관계.',
    higher: '현재 경기 체감 개선 → 소비 활발',
  ...
  '미시간 소비자기대지수(속보)': (
    desc: '소비자의 향후 경기 전망. 미래 소비·투자 결정에 영향을 주는 선행지표.',
    higher: '미래 전망 낙관 → 소비·투자 증가 기대',
    lower: '미래 전망 비관 → 소비·투자 위축 우려',
  ),
  '미시간 소비자기대지수(확정)': (
    desc: '소비자의 향후 경기 전망. 미래 소비·투자 결정에 영향을 주는 선행지표.',
    higher: '미래 전망 낙관 → 소비·투자 증가 기대',
  ...
  '미시간 인플레이션 기대(속보)': (
    desc: '소비자가 예상하는 1년 후 인플레이션율. 실제 물가에 자기실현적 영향.',
    higher: '기대 인플레 상승 → 연준 긴축 압력 → 시장 불안',
    lower: '기대 인플레 하락 → 물가 안정 기대 → 시장 안도',
  ),
  '미시간 인플레이션 기대(확정)': (
  ...
  '미시간 5년 인플레이션 기대(속보)': (
    desc: '소비자가 예상하는 5년 후 인플레이션율. 장기 물가 기대의 안정성을 측정.',
    higher: '장기 기대 인플레 상승 → 연준 정책 대응 필요 → 긴축 장기화',
    lower: '장기 기대 인플레 하락 → 물가 안정 기대 → 완화 여지',
  ),
  '미시간 5년 인플레이션 기대(확정)': (
    desc: '소비자가 예상하는 5년 후 인플레이션율. 장기 물가 기대의 안정성을 측정.',
    higher: '장기 기대 인플레 상승 → 연준 정책 대응 필요 → 긴축 장기화',
  ...
  // ─── 공장주문 / 제조 ───
  '공장주문 전월비': (
    desc: '제조업체에 대한 신규 주문 총액의 월간 변동. 내구재+비내구재를 모두 포함.',
    higher: '주문 증가 → 제조업 활황 → 경기 확장 신호',
    lower: '주문 감소 → 제조업 둔화 → 경기 수축 우려',
  ),
  '공장주문(운송제외)': (
    desc: '변동성 큰 운송장비를 제외한 공장주문. 핵심 제조업 수요 트렌드를 반영.',
    higher: '핵심 주문 증가 → 지속적 제조업 수요',
    lower: '핵심 주문 감소 → 구조적 수요 둔화',
  ),

  // ─── 에너지 (Baker Hughes / 천연가스) ───
  '베이커휴즈 원유시추기수': (
    desc: '미국 내 가동 중인 원유 시추기 수. 원유 공급 전망의 선행지표.',
    higher: '시추기 증가 → 향후 원유 공급 확대 → 유가 하락 압력',
    lower: '시추기 감소 → 향후 원유 공급 축소 → 유가 상승 압력',
  ),
  '베이커휴즈 총시추기수': (
    desc: '원유+천연가스 포함 전체 시추기 수. 에너지 산업 전반의 활동 수준.',
    higher: '시추 활동 확대 → 에너지 공급 증가 전망',
    lower: '시추 활동 축소 → 에너지 공급 감소 전망',
  ),
  'EIA 천연가스 재고 변동': (
    desc: 'EIA 주간 천연가스 지하 저장량 변동. 천연가스 가격에 직접 영향.',
    higher: '재고 증가 → 공급 충분 → 천연가스 가격 하락 압력',
    lower: '재고 감소 → 공급 부족 → 천연가스 가격 상승 압력',
  ),

  // ─── 재정 ───
  '월간 재정수지': (
    desc: '미국 연방정부의 월간 수입·지출 차이. 재정 건전성과 국채 발행 전망에 영향.',
    higher: '흑자/적자 축소 → 재정 건전 → 국채 발행 감소 기대',
    lower: '적자 확대 → 국채 발행 증가 → 금리 상승 압력',
  ),

  // ─── 실업수당 / 고용 세부 ───
  '실업수당 4주 이동평균': (
    desc: '주간 실업수당 청구건수의 4주 이동평균. 주간 변동성을 제거한 고용 추세.',
    higher: '실업 추세 상승 → 고용시장 약화 → 경기 둔화',
    lower: '실업 추세 하락 → 고용시장 건강 → 경기 활력',
  ),
  '정부부문 고용자수': (
    desc: '연방·주·지방 정부의 월간 고용 변동. 공공부문 고용 추세를 파악.',
    higher: '정부 고용 증가 → 재정 지출 확대',
    lower: '정부 고용 감소 → 재정 긴축 신호',
  ),
  '민간 비농업 고용자수': (
    desc: '정부를 제외한 민간부문 고용 변동. 민간 경제의 순수 고용 창출력.',
    higher: '민간 고용 증가 → 경제 활력 → 소비 증가 기대',
    lower: '민간 고용 감소 → 경기 둔화 → 소비 위축 우려',
  ),
  '평균시간당임금 전월비': (
    desc: '근로자 평균 시간당 임금의 월간 변동. 임금발 인플레이션 압력의 핵심 지표.',
    higher: '임금 상승 → 인플레 압력 → 금리 인상 가능',
    lower: '임금 둔화 → 인플레 완화 → 금리 인하 기대',
  ),
  '평균시간당임금 전년비': (
    desc: '근로자 평균 시간당 임금의 연간 변동. 장기 임금 인플레이션 추세 파악.',
    higher: '임금 상승 → 인플레 압력 → 금리 인상 가능',
    lower: '임금 둔화 → 인플레 완화 → 금리 인하 기대',
  ),
  '경제활동참가율': (
    desc: '생산가능인구 중 경제활동(취업+구직)에 참여하는 비율. 노동 공급의 구조적 지표.',
    higher: '참가율 상승 → 노동 공급 확대 → 임금 안정 효과',
    lower: '참가율 하락 → 노동 공급 축소 → 임금 상승 압력',
  ),
  'U6 실업률': (
    desc: '공식 실업자 + 비자발적 파트타임 + 구직 단념자를 포함한 광의 실업률.',
    higher: '광의 실업 증가 → 노동시장 실질 악화 → 경기 우려',
    lower: '광의 실업 감소 → 노동시장 실질 개선 → 경기 활력',
  ),
  '주간 평균근로시간': (
    desc: '민간 비농업 부문의 주간 평균 근로시간. 노동 수요의 선행지표.',
    higher: '근로시간 증가 → 고용 확대 선행 → 경기 활력',
    lower: '근로시간 감소 → 고용 축소 선행 → 경기 둔화',
  ),

  // ─── 개인소득/지출 ───
  '실질 개인지출 전월비': (
    desc: '인플레이션을 조정한 실질 개인지출 변동. 실제 소비 구매력 변화를 반영.',
    higher: '실질 소비 증가 → 경기 활력 → GDP 성장 기여',
    lower: '실질 소비 감소 → 경기 둔화 → GDP 하방 압력',
  ),
  '실질 소비지출 전분기비(최종)': (
    desc: 'GDP 구성요소 중 실질 소비지출의 분기별 최종치. GDP의 약 70%를 차지.',
    higher: '소비 성장 → GDP 성장 견인',
    lower: '소비 둔화 → GDP 성장 둔화',
  ),
  '기업이익 전분기비': (
    desc: '미국 기업 전체의 세전 이익 분기별 변동. 기업 실적과 주가의 펀더멘털.',
    higher: '이익 증가 → 주가 상승 근거 → 투자심리 개선',
    lower: '이익 감소 → 주가 하락 압력 → 투자심리 위축',
  ),
  '개인소득 전월비': (
    desc: '가계 총소득(임금+이자+배당 등)의 월간 변동. 소비 여력의 기반.',
    higher: '소득 증가 → 소비 여력 확대 → 경기 활력',
    lower: '소득 감소 → 소비 여력 축소 → 경기 둔화',
  ),
  '개인지출 전월비': (
    desc: '가계의 월간 소비 지출 변동. 미국 GDP의 약 70%를 차지하는 핵심 요소.',
    higher: '지출 증가 → 경기 활력 → GDP 성장 기여',
    lower: '지출 감소 → 경기 둔화 → GDP 하방 압력',
  ),

  // ─── 재고 / 무역 ───
  '도매재고 전월비': (
    desc: '도매업체의 재고 수준 월간 변동. 공급망 상태와 향후 주문량 예측에 활용.',
    higher: '재고 증가 → 수요 부진 or 향후 주문 감소 가능',
    lower: '재고 감소 → 수요 강세 or 향후 주문 증가 기대',
  ),
  '기업재고 전월비': (
    desc: '제조·도매·소매 전체 기업의 재고 수준 변동. 재고 순환과 경기 전환의 신호.',
    higher: '재고 증가 → 수요 부진 → 생산 조정 가능',
    lower: '재고 감소 → 수요 강세 → 생산 확대 기대',
  ),
  '무역수지': (
    desc: '수출과 수입의 차이. 적자 확대는 해외 수요 의존도 증가를 의미.',
    higher: '적자 축소/흑자 → 순수출 GDP 기여 → 달러 강세',
    lower: '적자 확대 → 순수출 GDP 감소 → 달러 약세',
  ),
  '경상수지': (
    desc: '무역수지+소득수지+이전수지를 합산한 대외거래 종합지표.',
    higher: '흑자/적자 축소 → 대외 건전성 개선 → 달러 강세',
    lower: '적자 확대 → 대외 부채 증가 → 달러 약세',
  ),

  // ─── 수입/수출 물가 ───
  '수입물가 전월비': (
    desc: '수입 상품·서비스 가격의 월간 변동. 해외발 인플레이션 압력을 반영.',
    higher: '수입물가 상승 → 인플레 상승 압력 → 비용 증가',
    lower: '수입물가 하락 → 인플레 완화 → 비용 감소',
  ),
  '수출물가 전월비': (
    desc: '수출 상품·서비스 가격의 월간 변동. 미국 기업의 해외 경쟁력과 수익성 반영.',
    higher: '수출물가 상승 → 기업 수익 개선 but 경쟁력 약화',
    lower: '수출물가 하락 → 기업 수익 감소 but 경쟁력 강화',
  ),

  // ─── 소비자 신뢰 / PMI ───
  'CB 소비자신뢰지수': (
    desc: 'Conference Board의 소비자 신뢰 조사. 5,000가구 대상 경기·고용·소득 전망.',
    higher: '소비자 신뢰 개선 → 소비 증가 기대 → 경기 활력',
    lower: '소비자 신뢰 악화 → 소비 위축 우려 → 경기 둔화',
  ),
  '시카고 PMI': (
    desc: '시카고 지역 제조업 구매관리자지수. ISM 제조업 PMI의 선행지표로 활용.',
    higher: '제조업 확장 → ISM PMI 호조 예상 → 경기 활력',
    lower: '제조업 수축 → ISM PMI 부진 예상 → 경기 둔화',
  ),

  // ─── 연준 지역 제조업지수 ───
  '달라스 연준 제조업지수': (
    desc: '텍사스 지역 제조업 활동을 측정. 0 이상이면 확장, 이하면 수축.',
    higher: '제조업 확장 → 지역 경기 활력',
    lower: '제조업 수축 → 지역 경기 둔화',
  ),
  '필라델피아 연준 제조업지수': (
    desc: '필라델피아 지역 제조업 활동. ISM 제조업 PMI의 선행지표로 주목.',
    higher: '제조업 확장 → 전국 제조업 활황 예상',
    lower: '제조업 수축 → 전국 제조업 둔화 우려',
  ),
  '리치먼드 연준 제조업지수': (
    desc: '리치먼드 연준 관할 지역(중부대서양) 제조업 활동.',
    higher: '제조업 확장 → 지역 경기 활력',
    lower: '제조업 수축 → 지역 경기 둔화',
  ),
  'NY 엠파이어 제조업지수': (
    desc: '뉴욕주 제조업 활동. 매월 가장 먼저 발표되어 제조업 선행지표로 활용.',
    higher: '제조업 확장 → 경기 선행 긍정',
    lower: '제조업 수축 → 경기 선행 부정',
  ),

  // ─── S&P 글로벌 PMI ───
  'S&P 글로벌 제조업 PMI': (
    desc: 'S&P 글로벌이 발표하는 제조업 구매관리자지수. ISM과 함께 경기 방향 판단.',
    higher: '제조업 확장 → 경기 활력 → 시장 긍정적',
    lower: '제조업 수축 → 경기 둔화 → 시장 부정적',
  ),
  'S&P 글로벌 서비스업 PMI': (
    desc: 'S&P 글로벌이 발표하는 서비스업 구매관리자지수. 서비스 경기 방향 판단.',
    higher: '서비스업 확장 → 경기 활력 → 시장 긍정적',
    lower: '서비스업 수축 → 경기 둔화 → 시장 부정적',
  ),
  'S&P 글로벌 종합 PMI': (
    desc: '제조업+서비스업을 합산한 종합 구매관리자지수. 전체 경기 방향의 종합 지표.',
    higher: '종합 확장 → 경기 전반 활력',
    lower: '종합 수축 → 경기 전반 둔화',
  ),

  // ─── 설비가동 / 제조업 생산 ───
  '설비가동률': (
    desc: '산업시설의 실제 생산량 대비 최대 생산능력 비율. 경기 과열/둔화 판단.',
    higher: '가동률 상승 → 경기 활황 → 인플레 압력 가능',
    lower: '가동률 하락 → 경기 둔화 → 유휴 설비 증가',
  ),
  '제조업 생산 전월비': (
    desc: '제조업 부문의 월간 생산량 변동. 산업 활동의 직접적 척도.',
    higher: '생산 증가 → 제조업 활황 → 경기 확장',
    lower: '생산 감소 → 제조업 부진 → 경기 둔화',
  ),

  // ─── 주택 ───
  '기존주택 판매': (
    desc: '기존 주택의 월간 판매 건수. 주택시장 수요와 소비자 신뢰를 반영.',
    higher: '판매 증가 → 주택시장 활성화 → 소비심리 개선',
    lower: '판매 감소 → 주택시장 둔화 → 소비심리 위축',
  ),
  '기존주택 판매 전월비': (
    desc: '기존 주택 판매의 월간 변동률. 주택시장 추세 변화를 추적.',
    higher: '판매 증가 → 주택시장 활성화 → 소비심리 개선',
    lower: '판매 감소 → 주택시장 둔화 → 소비심리 위축',
  ),
  '신규주택 판매': (
    desc: '신규 건설 주택의 월간 판매 건수. 건설업 활동과 경기 전망의 선행지표.',
    higher: '판매 증가 → 건설 활성화 → 경기 확장 신호',
    lower: '판매 감소 → 건설 둔화 → 경기 둔화 신호',
  ),
  '건축허가건수': (
    desc: '신규 주택 건축을 위한 허가 건수. 향후 주택 공급과 건설 투자의 선행지표.',
    higher: '허가 증가 → 건설 투자 확대 기대 → 경기 활력',
    lower: '허가 감소 → 건설 투자 위축 → 경기 둔화',
  ),
  '주택착공건수': (
    desc: '실제 건설이 시작된 신규 주택 수. 건설업 활동의 직접적 척도.',
    higher: '착공 증가 → 건설 활발 → 경기 확장',
    lower: '착공 감소 → 건설 둔화 → 경기 위축',
  ),

  // ─── 금리 / 모기지 ───
  '15년 모기지 금리': (
    desc: '15년 고정금리 모기지 평균 금리. 단기 대출 비용의 지표.',
    higher: '금리 상승 → 주택 구매 비용 증가 → 수요 억제',
    lower: '금리 하락 → 주택 구매 비용 감소 → 수요 촉진',
  ),
  '30년 모기지 금리': (
  ...
  // ─── 연준 대차대조표 ───
  '연준 대차대조표': (
    desc: '연준이 보유한 자산(국채, MBS 등) 총규모. 양적긴축/완화의 진행 상황을 파악.',
    higher: '자산 증가 → 유동성 공급 → 시장 긍정적',
    lower: '자산 감소 → 유동성 축소 → 시장 부정적',
  ),

  // ─── PCE 추가 ───
  'PCE 물가지수 전월비': (
    desc: '연준이 가장 선호하는 물가지표의 월간 변동. 소비 패턴 변화를 반영.',
    higher: '소비 과열 → 금리 인상 근거 → 시장 경계',
    lower: '소비 둔화 → 금리 인하 근거 → 시장 안도',
  ),
  'PCE 물가지수 전년비': (
    desc: '연준이 가장 선호하는 물가지표의 연간 변동. 물가 추세의 큰 그림.',
    higher: '소비 과열 → 금리 인상 근거 → 시장 경계',
    lower: '소비 둔화 → 금리 인하 근거 → 시장 안도',
  ),
  '근원 PCE 물가지수 연간변동': (
    desc: '식품·에너지 제외 PCE 물가의 연간 변동. 연준 물가 목표(2%)의 기준.',
    higher: '목표 초과 → 긴축 지속 → 시장 경계',
    lower: '목표 하회 → 완화 기대 → 시장 안도',
  ),

  // ─── 국채 입찰 (공통 설명 패턴) ───
  '2년물 국채 입찰': (
    desc: '미국 재무부 2년물 국채 입찰. 단기 금리 전망과 통화정책 기대를 반영.',
    higher: '수익률 상승 → 채권 수요 약세 → 금리 상승 압력',
    lower: '수익률 하락 → 채권 수요 강세 → 금리 하락 압력',
  ),
  '4주물 국채 입찰': (
    desc: '미국 재무부 4주물 단기 국채 입찰. 초단기 유동성 상황을 반영.',
    higher: '수익률 상승 → 단기 유동성 수요 → 금리 상승',
    lower: '수익률 하락 → 유동성 충분 → 금리 하락',
  ),
  '5년물 국채 입찰': (
    desc: '미국 재무부 5년물 국채 입찰. 중기 금리 전망을 반영.',
    higher: '수익률 상승 → 채권 수요 약세 → 금리 상승 압력',
    lower: '수익률 하락 → 채권 수요 강세 → 금리 하락 압력',
  ),
  '7년물 국채 입찰': (
    desc: '미국 재무부 7년물 국채 입찰. 중장기 금리 전망을 반영.',
    higher: '수익률 상승 → 채권 수요 약세 → 금리 상승 압력',
    lower: '수익률 하락 → 채권 수요 강세 → 금리 하락 압력',
  ),
  '8주물 국채 입찰': (
    desc: '미국 재무부 8주물 단기 국채 입찰. 단기 유동성 상황을 반영.',
    higher: '수익률 상승 → 단기 유동성 수요 → 금리 상승',
    lower: '수익률 하락 → 유동성 충분 → 금리 하락',
  ),
  '13주물 국채 입찰': (
    desc: '미국 재무부 13주물(3개월) 단기 국채 입찰. 단기 금리 기준점.',
    higher: '수익률 상승 → 금리 상승 압력',
    lower: '수익률 하락 → 금리 하락 압력',
  ),
  '17주물 국채 입찰': (
    desc: '미국 재무부 17주물 단기 국채 입찰. 단기 금리 동향을 반영.',
    higher: '수익률 상승 → 금리 상승 압력',
    lower: '수익률 하락 → 금리 하락 압력',
  ),
  '20년물 국채 입찰': (
    desc: '미국 재무부 20년물 장기 국채 입찰. 장기 금리 전망을 반영.',
    higher: '수익률 상승 → 채권 수요 약세 → 금리 상승 압력',
    lower: '수익률 하락 → 채권 수요 강세 → 금리 하락 압력',
  ),
  '26주물 국채 입찰': (
    desc: '미국 재무부 26주물(6개월) 단기 국채 입찰. 반기 금리 동향 반영.',
    higher: '수익률 상승 → 금리 상승 압력',
    lower: '수익률 하락 → 금리 하락 압력',
  ),
  '52주물 국채 입찰': (
    desc: '미국 재무부 52주물(1년) 단기 국채 입찰. 1년 금리 전망 반영.',
    higher: '수익률 상승 → 금리 상승 압력',
    lower: '수익률 하락 → 금리 하락 압력',
  ),
};
